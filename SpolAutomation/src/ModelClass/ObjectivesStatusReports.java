...
public class ObjectivesStatusReports {
	WebDriver driver;

	public ObjectivesStatusReports(WebDriver driver) {
		this.driver=driver;
	}
	...
	public WebElement getObjectiveIntendedResultPageHeaderText() throws InterruptedException {
		Thread.sleep(2000);
		driver.findElement(findStatusReportsLink).click();
		Thread.sleep(2000);
		//Scroll window
