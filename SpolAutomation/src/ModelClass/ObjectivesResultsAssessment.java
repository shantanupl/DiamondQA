...
public class ObjectivesResultsAssessment {
	WebDriver driver;

	public ObjectivesResultsAssessment(WebDriver driver) {
		this.driver=driver;
	}
	...
	public WebElement getObjectiveIntendedResultPageHeaderText() throws InterruptedException {
		Thread.sleep(2000);
		driver.findElement(findAssessmentMeasuresLink).click();
		Thread.sleep(2000);
		//Scroll window
