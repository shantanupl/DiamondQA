...
public class ObjectivesTasksAssignments {
	WebDriver driver;
	...
	public ObjectivesTasksAssignments() {
...
//        element.click();
        Thread.sleep(2000);
		//Assignments Start
		if(objectives.getObjectiveClickAssignmentsLink().isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
		if(objectives.getObjectiveClickPlusIconNewPopupDisplay().isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
		if(objectives.getObjectiveFilterByDropdownDisplayByDefault().isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
		if(objectives.getObjectiveNumberOfUserDisplaySinglePage().get(6).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
		if(objectives.getObjectiveUserSearchFilter().get(1).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
		if(objectives.getObjectiveEmailSearchFilter().get(1).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
		if(objectives.getObjectiveAssignmentsCheckBoxSelection().get(1).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
		if(objectives.getObjectiveAssignmentsSaveAllInfo().get(1).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
		if(objectives.getObjectiveAssignmentsValueDisplay().get(1).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
		if(objectives.getObjectiveUserAssignmentsValueDisplay().get(1).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
		if(objectives.getObjectiveAssignmentsPlaningUnitCheckBox().get(0).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
		if(objectives.getObjectiveAssignmentsPlaningUnitSaveAllInfo().get(1).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
		if(objectives.getObjectiveAssignmentsExternalContributorsDropDownSelection().isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
		if(objectives.getObjectiveAssignmentsExternalContributorDisabledPlusButton().isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
		if(objectives.getObjectiveAssignmentsExternalContributorFirstNameRequiredErrorMessage().isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
		if(objectives.getObjectiveAssignmentsExternalContributorThreeFieldFillupPlusIconEnabled().isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
		if(objectives.getObjectiveAssignmentsExternalContributorPlusIconSaveAllInfo().get(1).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
		if(objectives.getObjectiveAssignmentsExternalContributorCheckAnyCheckBox().get(1).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
		if(objectives.getObjectiveAssignmentsExternalContributorSaveAllInfo().get(1).isDisplayed()) {
		testcase1.add("Pass");
	     }
	   else {
		   testcase1.add("Fail");
	    ...
	    ExcelUtil.writeToFile(498, testcase1);		
	}
