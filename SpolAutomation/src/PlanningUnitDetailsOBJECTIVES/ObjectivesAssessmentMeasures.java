...
public class ObjectivesAssessmentMeasures {
	WebDriver driver;
	...
	Goals goals;
	ObjectivesResultsAssessment objectives;
	...
	public ObjectivesAssessmentMeasures() {
	...
	public void verifyAddTaskPage() throws InterruptedException, IOException, FindFailed {
		...
		objectives=new ObjectivesResultsAssessment(driver);
	    ...
	    ExcelUtil.writeToFile(529, testcase1);		
	}
