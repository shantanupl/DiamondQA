...
public class ObjectivesStatusReportsResults {
	WebDriver driver;
	...
	Goals goals;
	ObjectivesStatusReports objectives;
	...
	public ObjectivesStatusReportsResults() {
	...
	public void verifyAddTaskPage() throws InterruptedException, IOException, FindFailed {
		...
		objectives=new ObjectivesStatusReports(driver);
	    ...
	    ExcelUtil.writeToFile(540, testcase1);		
	}
