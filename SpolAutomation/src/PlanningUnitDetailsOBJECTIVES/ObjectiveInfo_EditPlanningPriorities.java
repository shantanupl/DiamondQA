...
public class ObjectiveInfo_EditPlanningPriorities {
	WebDriver driver;
	...
	public ObjectiveInfo_EditPlanningPriorities() {
		// TODO Auto-generated constructor stub
	}
	
	@Test
	public void testEditPlanningPriorities() throws InterruptedException, IOException {
		...
		driver.findElement(By.xpath("//tbody/tr[1]/td[1]/input[1]")).click();
		driver.findElement(By.xpath("/html[1]/body[1]/app-root[1]/div[1]/div[1]/div[1]/app-objective[1]/merge-com[1]/div[1]/div[2]/app-objective-planning-priority[1]/div[1]/div[3]/kendo-grid[1]/div[1]/kendo-grid-list[1]/div[1]/div[1]/table[1]/tbody[1]/tr[2]/td[2]/input[1]")).click();
		driver.findElement(By.xpath("//button[contains(text(),'Save')]")).click();
		Thread.sleep(2000);
		...
		testcase1.add("Not executed");
	    ExcelUtil.writeToFile(372, testcase1);				
