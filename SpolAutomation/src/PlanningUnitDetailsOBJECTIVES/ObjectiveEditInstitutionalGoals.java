...
public class ObjectiveEditInstitutionalGoals {
	WebDriver driver;
	...
	public ObjectiveEditInstitutionalGoals() {
		// TODO Auto-generated constructor stub
	}
	
	@Test
	public void testEditInstitutionalGoals() throws InterruptedException, IOException {
		...
		wait5.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[contains(text(),'Category1')]")));
		...
		driver.findElement(By.xpath("//button[contains(text(),'Save')]")).click();
		Thread.sleep(4000);
		if(driver.findElement(By.xpath("//body/app-root[1]/div[1]/div[1]/div[1]/app-objective[1]/merge-com[1]/div[1]/div[1]/objective-detail-home[1]/div[1]/app-objective-inst-goal-info[1]/div[1]/div[1]/div[1]/div[2]/div[3]/p[1]")).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//button[contains(text(),'Save')]")).click();
		WebDriverWait wait6 = new WebDriverWait(driver,2000);
		wait6.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//body/app-root[1]/div[1]/div[1]/div[1]/app-objective[1]/merge-com[1]/div[1]/div[1]/objective-detail-home[1]/div[1]/app-objective-inst-goal-info[1]/div[1]/div[1]/div[1]/div[2]/div[5]/p[1]")));
		if(driver.findElement(By.xpath("//body/app-root[1]/div[1]/div[1]/div[1]/app-objective[1]/merge-com[1]/div[1]/div[1]/objective-detail-home[1]/div[1]/app-objective-inst-goal-info[1]/div[1]/div[1]/div[1]/div[2]/div[5]/p[1]")).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		...
		testcase1.add("Not executed");
	    ExcelUtil.writeToFile(309, testcase1);				
	}
