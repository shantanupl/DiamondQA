...
public class ObjectivesUseOfResultsTest {
	WebDriver driver;
	...
	Goals goals;
	ObjectivesUseOfResults objectives;
	...
	public ObjectivesUseOfResultsTest() {
	...
	public void verifyAddTaskPage() throws InterruptedException, IOException, FindFailed {
		...
		objectives=new ObjectivesUseOfResults(driver);
		...
		Thread.sleep(5000);
		//objectives.addUseOfResultsData();
		//objectives.deleteUseOfResultsData();
	    ...
	    ExcelUtil.writeToFile(562, testcase1);		
	}
