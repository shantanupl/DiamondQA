...
public class ObjectiveInfoEDITGoalsTypesPriorities {
	WebDriver driver;
	...
	public ObjectiveInfoEDITGoalsTypesPriorities() {
		// TODO Auto-generated constructor stub
	}
	
	@Test
	public void testEditGoalsTypesPriorities() throws InterruptedException, IOException {
		...
		driver.findElement(By.xpath("//button[contains(text(),'Save')]")).click();
		Thread.sleep(3000);
		if(driver.findElement(By.xpath("//body/app-root[1]/div[1]/div[1]/div[1]/app-objective[1]/merge-com[1]/div[1]/div[1]/objective-detail-home[1]/div[1]/app-objective-goal-type-priority-info[1]/div[1]/div[1]/div[1]/div[2]/div[2]/p[1]")).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		...
		testcase1.add("Not executed");
	    ExcelUtil.writeToFile(330, testcase1);				
