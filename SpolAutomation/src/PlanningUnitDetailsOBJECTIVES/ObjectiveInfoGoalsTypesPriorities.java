...
public class ObjectiveInfoGoalsTypesPriorities {
	WebDriver driver;
	...
	public ObjectiveInfoGoalsTypesPriorities() {
		// TODO Auto-generated constructor stub
	}
	
	@Test
	public void testGoalsTypesPrioriries() throws InterruptedException, IOException {
		...
		if(driver.findElement(By.xpath("//body/app-root[1]/div[1]/div[1]/div[1]/app-objective[1]/merge-com[1]/div[1]/div[1]/objective-detail-home[1]/div[1]/app-objective-goal-type-priority-info[1]/div[1]/div[1]/div[1]/div[2]")).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
		driver.findElement(By.xpath("//div[contains(text(),'Goals, Types, & Priorities')]")).click();
		Thread.sleep(2000);
		if(driver.findElement(By.xpath("//h6[contains(text(),'Planning Unit Goal')]")).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
		if(driver.findElement(By.xpath("//thead/tr[1]/th[1]/a[1]")).isDisplayed()
				&&driver.findElement(By.xpath("//label[contains(text(),'Sel')]")).isDisplayed()
				&&driver.findElement(By.xpath("//thead/tr[1]/th[3]/a[1]")).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
		driver.findElement(By.xpath("/html[1]/body[1]/app-root[1]/div[1]/div[1]/div[1]/app-objective[1]/merge-com[1]/div[1]/div[2]/app-objective-planning-unit-goal[1]/div[1]/div[3]/kendo-grid[1]/div[1]/kendo-grid-list[1]/div[1]/div[1]/table[1]/tbody[1]/tr[1]/td[2]/input[1]")).click();
		...
		if(driver.findElement(By.xpath("/html[1]/body[1]/app-root[1]/div[1]/div[1]/div[1]/app-objective[1]/merge-com[1]/div[1]/div[2]/app-objective-planning-unit-goal[1]/div[1]/div[3]/kendo-grid[1]/div[1]/kendo-grid-list[1]/div[1]/div[1]/table[1]/tbody[1]/tr[1]/td[2]/input[1]")).isSelected()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		...
		if(driver.findElement(By.xpath("//thead/tr[2]/td[3]/kendo-grid-string-filter-cell[1]/kendo-grid-filter-wrapper-cell[1]/input[1]")).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
		driver.findElement(By.xpath("//thead/tr[2]/td[3]/kendo-grid-string-filter-cell[1]/kendo-grid-filter-wrapper-cell[1]/input[1]")).sendKeys("Goal T");
		Thread.sleep(1000);
		if(driver.findElement(By.xpath("//td[contains(text(),'Goal Title2')]")).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		...
		driver.findElement(By.xpath("//thead/tr[2]/td[3]/kendo-grid-string-filter-cell[1]/kendo-grid-filter-wrapper-cell[1]/input[1]")).clear();
		testcase1.add("Not executed");
		driver.findElement(By.xpath("//tbody/tr[1]/td[1]/input[1]")).click();
		driver.findElement(By.xpath("//button[contains(text(),'Save')]")).click();
		Thread.sleep(3000);
		...
		if(driver.findElement(By.xpath("//body/app-root[1]/div[1]/div[1]/div[1]/app-objective[1]/merge-com[1]/div[1]/div[1]/objective-detail-home[1]/div[1]/app-objective-goal-type-priority-info[1]/div[1]/div[1]/div[1]/div[2]/div[1]/p[1]")).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		...
		Thread.sleep(2000);
		testcase1.add("Not executed");
		driver.findElement(By.xpath("/html[1]/body[1]/app-root[1]/div[1]/div[1]/div[1]/app-objective[1]/merge-com[1]/div[1]/div[2]/app-objective-planning-unit-goal[1]/div[1]/div[3]/kendo-grid[1]/div[1]/kendo-grid-list[1]/div[1]/div[1]/table[1]/tbody[1]/tr[2]/td[2]/input[1]")).click();
		driver.findElement(By.xpath("//button[contains(text(),'Save')]")).click();
		Thread.sleep(5000);
		if(driver.findElement(By.xpath("//body/app-root[1]/div[1]/div[1]/div[1]/app-objective[1]/merge-com[1]/div[1]/div[1]/objective-detail-home[1]/div[1]/app-objective-goal-type-priority-info[1]/div[1]/div[1]/div[1]/div[2]/div[1]/p[1]/span[1]")).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
	    ExcelUtil.writeToFile(316, testcase1);				
	}
