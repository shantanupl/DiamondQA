...
public class ObjectiveInfo_ObjectiveType {
	WebDriver driver;
	...
	public ObjectiveInfo_ObjectiveType() {
		// TODO Auto-generated constructor stub
	}
	
	@Test
	public void testObjectiveType() throws InterruptedException, IOException {
		...
		if(driver.findElement(By.xpath("//h6[contains(text(),'Objective Type')]")).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		...
		driver.findElement(By.xpath("//thead/tr[2]/td[3]/kendo-grid-string-filter-cell[1]/kendo-grid-filter-wrapper-cell[1]/input[1]")).sendKeys("Test O");
		Thread.sleep(2000);
		if(driver.findElement(By.xpath("//td[contains(text(),'Test Objective Type1')]")).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		...
		if(driver.findElement(By.xpath("//body/app-root[1]/div[1]/div[1]/div[1]/app-objective[1]/merge-com[1]/div[1]/div[1]/objective-detail-home[1]/div[1]/app-objective-goal-type-priority-info[1]/div[1]/div[2]/div[1]/div[2]/div[2]/p[1]")).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		...
		if(driver.findElement(By.xpath("//body/app-root[1]/div[1]/div[1]/div[1]/app-objective[1]/merge-com[1]/div[1]/div[1]/objective-detail-home[1]/div[1]/app-objective-goal-type-priority-info[1]/div[1]/div[2]/div[1]/div[2]/div[1]/p[1]/span[1]")).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
	    ExcelUtil.writeToFile(337, testcase1);				
