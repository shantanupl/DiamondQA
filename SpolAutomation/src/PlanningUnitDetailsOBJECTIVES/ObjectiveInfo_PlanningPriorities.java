...
public class ObjectiveInfo_PlanningPriorities {
	WebDriver driver;
	...
	public ObjectiveInfo_PlanningPriorities() {
		// TODO Auto-generated constructor stub
	}
	
	@Test
	public void testPlanningPriorities() throws InterruptedException, IOException {
		...
		if(driver.findElement(By.xpath("//body/app-root[1]/div[1]/div[1]/div[1]/app-objective[1]/merge-com[1]/div[1]/div[1]/objective-detail-home[1]/div[1]/app-objective-goal-type-priority-info[1]/div[1]/div[3]/div[1]/div[2]")).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
		driver.findElement(By.xpath("//div[contains(text(),'Planning Priorities')]")).click();
		Thread.sleep(2000);
		JavascriptExecutor jr2 = (JavascriptExecutor)driver;
		jr2.executeScript("window.scrollBy(0,-1000)");
		if(driver.findElement(By.xpath("//h6[contains(text(),'Planning Priorities')]")).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		...
		driver.findElement(By.xpath("/html[1]/body[1]/app-root[1]/div[1]/div[1]/div[1]/app-objective[1]/merge-com[1]/div[1]/div[2]/app-objective-planning-priority[1]/div[1]/div[3]/kendo-grid[1]/div[1]/kendo-grid-list[1]/div[1]/div[1]/table[1]/tbody[1]/tr[1]/td[2]/input[1]")).click();
		...
		Thread.sleep(1000);
		if(driver.findElement(By.xpath("/html[1]/body[1]/app-root[1]/div[1]/div[1]/div[1]/app-objective[1]/merge-com[1]/div[1]/div[2]/app-objective-planning-priority[1]/div[1]/div[3]/kendo-grid[1]/div[1]/kendo-grid-list[1]/div[1]/div[1]/table[1]/tbody[1]/tr[1]/td[2]/input[1]")).isSelected()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		...
		driver.findElement(By.xpath("//thead/tr[2]/td[3]/kendo-grid-string-filter-cell[1]/kendo-grid-filter-wrapper-cell[1]/input[1]")).sendKeys("Planning Priority1");
		Thread.sleep(1000);
		if(driver.findElement(By.xpath("//td[contains(text(),'Planning Priority1')]")).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		...
		if(driver.findElement(By.xpath("//body/app-root[1]/div[1]/div[1]/div[1]/app-objective[1]/merge-com[1]/div[1]/div[1]/objective-detail-home[1]/div[1]/app-objective-goal-type-priority-info[1]/div[1]/div[3]/div[1]/div[2]/div[1]/p[1]")).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		...
		if(driver.findElement(By.xpath("//body/app-root[1]/div[1]/div[1]/div[1]/app-objective[1]/merge-com[1]/div[1]/div[1]/objective-detail-home[1]/div[1]/app-objective-goal-type-priority-info[1]/div[1]/div[3]/div[1]/div[2]/div[1]/p[1]/span[1]")).isDisplayed()) {
			testcase1.add("Pass");
		}
		else {
			testcase1.add("Fail");
		}
	    ExcelUtil.writeToFile(358, testcase1);				
	}
